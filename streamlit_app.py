...
def getfruityvice_data(this_fruit_choice):
    fruityvice_response=request.get("https://fruityvice.com/api/fruit/" + this_is_fruit_choice)
...
try:
  ...
  if not fruit_choice:
    ...
    fruityvice_response = request.get("http://fruityvice.com/api/fruit/" + fruit_choice)
    fruityvice_normalized = pandas.json_normalize(fruityvice_response.json())
...
#allow user to add a fruit to the lis
